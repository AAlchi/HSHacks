...
const Button: React.FC<ButtonInterface> = ({
  ...
  return (
    <button className={`buttonStyle flex gap-2 rounded-lg px-5 py-3 font-bold whitespace-nowrap ${name == "Sign Up for HSHacks" ? "bg-white text-slate-500" : "bg-blue-800 text-white"}`}> 
        {name}
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
              {name != "Sign Up for HSHacks" ? (
