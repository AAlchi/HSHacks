    ...
    return (
        <div className='background'>
            <div className='text-white flex flex-col items-center justify-between h-screen gap-10'>
                ...
                <div className='w-full bg-white text-black flex justify-evenly' style={{ opacity: 0.8 }}>
                    <h1 className='text-lg py-4 text-center'>Questions? Contact us at <span className='font-bold'>team@hshacks.org</span></h1>
                </div>
            </div>
        </div>
    )
