...
const HistoryLanding = () => {
    return ( 
          ...
          <div className='text-white flex flex-col items-center justify-between h-screen gap-10'> 
                  <div className='text-center h-screen flex flex-col gap-10 items-center pt-20 justify-center px-4 md:px-8 lg:px-16' style={{minHeight: "300px"}}>
                  <div className='flex flex-col gap-3'>
                        <h1 className='text-6xl font-extrabold'><span className="HSBlue">HSHacks</span> 2024</h1> 
                    </div> 
                  </div>
                  <div className='w-full text-white flex justify-center pb-10' style={{opacity: 0.8}}>
